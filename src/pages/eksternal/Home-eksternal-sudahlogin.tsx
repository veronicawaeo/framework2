...
import '../eksternal/Home-eksternal-sudahlogin.css';
import '../eksternal/GedungPage-eksternal.tsx';
import { ruangDipakaiList } from '../../data/dataRuanganDipakai';

interface GedungDataEksternal {
  category: string;
  title: string;
  description: string;
  image: string;
...
const gedungList: GedungDataEksternal[] = [
  {
    ...
    link: '/eksternal/gedung-lab-eksternal'
  },
  {
    category: 'Fakultas Teknik',
    title: 'Gedung PTI',
    ...
    link: '/eksternal/gedung-pti-eksternal'
  }
];

const HomeEksternal: React.FC = () => {
    ...
    <div className="container mt-4">
      ...
      <div className="hero-section">
        ...
        <div className="hero-text">
          ...
          <button
            onClick={() => {
              const gedungSection = document.getElementById('gedung-eksternal');
